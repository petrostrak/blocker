...
type Block struct {
	...
	Transactions []*Transcation `protobuf:"bytes,2,rep,name=transactions,proto3" json:"transactions,omitempty"`
}
...
func (x *Block) GetTransactions() []*Transcation {
	if x != nil {
...
type Header struct {
	...
	RootHash  []byte `protobuf:"bytes,4,opt,name=rootHash,proto3" json:"rootHash,omitempty"` // merkle root of the block
...
type TxInput struct {
	...
	Signarure    []byte `protobuf:"bytes,4,opt,name=signarure,proto3" json:"signarure,omitempty"`
}
...
func (x *TxInput) GetSignarure() []byte {
	if x != nil {
		return x.Signarure
	}
	return nil
...
type Transcation struct {
	...
	Version   int32       `protobuf:"varint,1,opt,name=version,proto3" json:"version,omitempty"`
	TxInputs  []*TxInput  `protobuf:"bytes,2,rep,name=TxInputs,proto3" json:"TxInputs,omitempty"`
	TxOutputs []*TxOutput `protobuf:"bytes,3,rep,name=TxOutputs,proto3" json:"TxOutputs,omitempty"`
}

func (x *Transcation) Reset() {
	*x = Transcation{}
	if protoimpl.UnsafeEnabled {
...
func (x *Transcation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Transcation) ProtoMessage() {}

func (x *Transcation) ProtoReflect() protoreflect.Message {
	mi := &file_proto_types_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Transcation.ProtoReflect.Descriptor instead.
func (*Transcation) Descriptor() ([]byte, []int) {
	return file_proto_types_proto_rawDescGZIP(), []int{4}
}

func (x *Transcation) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *Transcation) GetTxInputs() []*TxInput {
	if x != nil {
		return x.TxInputs
	}
	return nil
...
func (x *Transcation) GetTxOutputs() []*TxOutput {
	if x != nil {
		return x.TxOutputs
	}
	return nil
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	0x6d, 0x70, 0x22, 0x85, 0x01, 0x0a, 0x07, 0x54, 0x78, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x1a,
	0x0a, 0x08, 0x70, 0x72, 0x65, 0x76, 0x48, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x08, 0x70, 0x72, 0x65, 0x76, 0x48, 0x61, 0x73, 0x68, 0x12, 0x22, 0x0a, 0x0c, 0x70, 0x72,
	...
	0x73, 0x69, 0x67, 0x6e, 0x61, 0x72, 0x75, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x72, 0x75, 0x72, 0x65, 0x22, 0x3c, 0x0a, 0x08, 0x54, 0x78,
	...
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x76, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x24, 0x0a, 0x08, 0x54, 0x78, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x54, 0x78, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x52, 0x08, 0x54,
	0x78, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x12, 0x27, 0x0a, 0x09, 0x54, 0x78, 0x4f, 0x75, 0x74,
	...
	0x65, 0x74, 0x72, 0x6f, 0x73, 0x74, 0x72, 0x61, 0x6b, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x65,
...
var file_proto_types_proto_goTypes = []interface{}{
	...
	(*Transcation)(nil), // 4: Transcation
}
var file_proto_types_proto_depIdxs = []int32{
	1, // 0: Block.header:type_name -> Header
	4, // 1: Block.transactions:type_name -> Transcation
	2, // 2: Transcation.TxInputs:type_name -> TxInput
	3, // 3: Transcation.TxOutputs:type_name -> TxOutput
